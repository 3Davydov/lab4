...
public class EngineProviderView implements DetailProviderView{
    ...
    public EngineProviderView() {
        ...
        textField = new JTextArea("Engine Provider Delay : " + Integer.toString(slider.getValue()) + "\nDetails Provided : " + Integer.toString(detailsCount), 2, 1);
        ...
        slider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                textField.setText("Engine Provider Delay : " + Integer.toString(slider.getValue()) + "\nDetails Provided : " + Integer.toString(detailsCount));
    ...
    public void setProvider(DetailProvider newProvider) {
        ...
        if (provider.notInterrupted())
            slider.setValue(newProvider.getCurrentDelay() / 1000);
    }
